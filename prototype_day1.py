# Lisan Technical Prototype
# Day 1: Testing the translation pipeline
...
def test_basic_translation():
    """
    Test with sample phrases without API keys first
    """
    print("=" * 50)
    print("LISAN TECHNICAL PROTOTYPE - DAY 1")
    print("=" * 50)
    print()
    ...
    keys_status = {
        ...
        "OpenAI (Whisper)": bool(translator.openai_key)
    }
    ...
    if not all(keys_status.values()):
        print("⚠️  Some API keys are missing. Create .env file with:")
        print("   OPENAI_API_KEY=your_key")
        print("   DEEPL_API_KEY=your_key")
        print("   ELEVENLABS_API_KEY=your_key")
        print("   DEEPSEEK_API_KEY=your_key")
    else:
        print("🚀 All keys set! Ready for testing.")
    
    return translator


if __name__ == "__main__":
    translator = test_basic_translation()
